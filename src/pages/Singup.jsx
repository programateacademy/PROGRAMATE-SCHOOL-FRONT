        ...
        <div className='h-full grid grid-rows-3 md:h-screen md:grid-rows-1 md:grid-cols-2'>
            ...
            <div className='row-span-2 bg-light py-6 my-auto'>
                ...
                <div className='mx-12 sm:mx-40 md:mx-16 lg:mx-28 pb-6'>
                    <h3 className='pb-1.5 text-dark text-sm font-Nunito font-black'>Nombre:</h3>
                    <input type='text' placeholder='nombre apellidos' className='w-full px-1 py-1 rounded border-2 border-yellow text-dark/50 text-xs font-Poppins'></input>
                </div>
                <div className='mx-12 sm:mx-40 md:mx-16 lg:mx-28 pb-6'>
