    ...
    return (
        <main className='container'>
            ...
            <section className=''>
                ...
                <section className=''>
                    <h1 className=' font-bold font-Poppins text-md md:text-xl lg:text-3xl'>Convocatorias abiertas</h1>
                    ...
                    <section className='md:flex md:justify-around md:items-center md:gap-4 text-center'>
                        ...
                        <figure className='mx-4 flex flex-col justify-center items-center md:col-start-4 lg:pt-0'>
                            <h2 className='font-Poppins font-semibold m-2 mt-10 text-sm md:text-lg lg:text-xl'>¿Tienes algún problema o dificultad con tu proceso?</h2>
