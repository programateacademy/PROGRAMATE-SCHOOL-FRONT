    ...
    return (
        ...
        <div className='h-screen grid grid-rows-3 md:grid-rows-1 md:grid-cols-2'>
            ...
            <div className='row-span-2 bg-light py-6 my-auto'>
                ...
                <h4 className='mx-20 md:mx-16 pt-6 text-center text-dark text-sm font-Nunito'>¿No tienes una cuenta?<br/><a href='https://github.com/programateacademy/PROGRAMATE-SCHOOL-FRONT' target='_blank'><b>Ingresa aquí</b></a>.</h4>
            </div>
        </div>
        </div>
    )
