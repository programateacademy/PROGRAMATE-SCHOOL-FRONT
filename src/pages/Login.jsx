    ...
    return (
        ...
        <div className='h-screen grid grid-rows-3 md:grid-rows-1 md:grid-cols-2'>
            ...
            <div className='row-span-2 bg-light py-6 my-auto'>
                ...
                <Link to='/Singup'><img className='mx-auto w-[25%] pb-6 md:hidden' src={'https://github.com/MariaHerrera03/ImageBank/blob/main/Progr%C3%A1mateSchool/programate-school-negros.png?raw=true'} alt='Imagen personalizados'/></Link>
                ...
                <div className='mx-12 sm:mx-40 md:mx-16 lg:mx-28 pb-6 relative'>
                    ...
                    <h5 className='pt-1 text-center text-dark text-xs font-Nunito italic'>Olvidaste tu contraseña, <a href='https://github.com/programateacademy/PROGRAMATE-SCHOOL-FRONT' target='_blank'><b>recupérala aquí</b></a></h5>
                </div>
                <button onClick={loginPerson} className='flex mx-auto px-6 py-1 bg-yellow shadow-md shadow-dark/50 hover:bg-red text-center text-light text-sm font-Poppins font-medium'>Ingresar</button>
                <h4 className='mx-20 md:mx-16 pt-6 text-center text-dark text-sm font-Nunito'>¿No tienes una cuenta?</h4>
                <Link to='/Singup'><h4 className='mx-20 md:mx-16 text-center text-dark text-sm font-Nunito'><b>Ingresa aquí</b>.</h4></Link>
            </div>
        </div>
        </div>
    )
