        ...
        <div>Motivation
            <div className='flex h-72 '>
                ...
                <div className=' w-7/12 sm:w-5/12 md:w-9/12 m-auto '>
                    <img className='bg-light/90 rounded-lg p-2 md:p-4 shadow-2xl backdrop-saturate-200' src={'https://github.com/MariaHerrera03/ImageBank/blob/main/Progr%C3%A1mateSchool/programate-school-color.png?raw=true'} />
                </div>
            </div>
