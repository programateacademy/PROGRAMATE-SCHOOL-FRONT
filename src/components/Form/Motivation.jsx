                ...
                <section
                    ...
                    className='font-Nunito'>
                            ...
                            <div className='flex flex-row'>
                                ...
                                <h3 className=' font-Nunito font-semibold ml-4'>Quiero ser parte de Prográmate School porque la programación siempre me ha interesado y con esta oportunidad podré ampliar mis conocimientos en esta área.</h3>
                            </div>
                            <div className='flex flex-row'>
                                <label className='flex justify-center font-Poppins font-extrabold text-center'>
                                    <input
                                ...
                                <h3 className=' font-Nunito font-semibold indent-4'>Quiero ser parte de Prográmate porque me va a ayudar a adquirir conocimientos para ser influencer.</h3>
                            </div>
                            <div className='flex flex-row'>
                                <label className='flex justify-center font-Poppins font-extrabold text-center'>
                                    <input
                    ...
                    className='font-Nunito'>
                        <article className='mx-12 sm:mx-40 md:mx-16 lg:mx-28 pb-6'>
                            ...
                            <label className='flex justify-center font-Poppins font-extrabold text-center'>
                                ...
                                <h3 className=' font-Nunito font-semibold ml-4'>Es presencial y las clases son como las de mi colegio.</h3>
                            </div>
                            <div className='flex flex-row'>
                            <label className='flex justify-center font-Poppins font-extrabold text-center'>
                                    <input
                                ...
                                <h3 className=' font-Nunito font-semibold indent-4'>El tipo de aprendizaje, ya que permite aprender desde la práctica con ejemplos reales.</h3>
                            </div>
                            <div className='flex flex-row'>
                                <label className='flex justify-center font-Poppins font-extrabold text-center'>
                                    <input
                                ...
                                <h3 className=' font-Nunito font-semibold indent-4'>Que el estudio es 100% virtual y en horario de la tarde.</h3>
                            </div>
                    </article>
                    ...
                    className='font-Nunito'>
                        <article className='mx-12 sm:mx-40 md:mx-16 lg:mx-28 pb-6'>
                            ...
                            <div className='flex flex-row'>
                                ...
                                <h3 className=' font-Nunito font-semibold ml-4'>Poder tener conocimientos en tecnología y así poner en práctica mi conocimiento de programación cuando entre a la universidad.</h3>
                            </div>
                            <div className='flex flex-row'>
                                <label className='flex justify-center font-Poppins font-extrabold text-center'>
                                    <input
                                ...
                                <h3 className=' font-Nunito font-semibold indent-4'>Tener un trabajo que me dé mucho dinero.</h3>
                            </div>
                            <div className='flex flex-row'>
                                <label className='flex justify-center font-Poppins font-extrabold text-center'>
                                    <input
                                ...
                                <h3 className=' font-Nunito font-semibold indent-4'>Tener una calidad de vida haciendo lo que más me apasiona que es la programación y apoyando a otros.</h3>
                            </div>
                    </article>
                ...
                <div className='mx-12 sm:mx-40 md:mx-16 lg:mx-28 pb-6'>
                    ...
                    <select
                        ...
                        className={errors.withdrawal && touched.withdrawal ? 'w-full px-2 py-1 rounded border-2 border-red text-dark/50 text-xs font-Poppins md:items-center md:w-1/2' : 'w-full p-1 bg-light rounded border-2 border-yellow text-dark/50 text-xs font-Poppins font-medium md:items-center md:w-1/2'} >
                            ...
                            <option className='font-medium text-dark'>retirarme del colegio</option>
                            <option className='font-medium text-dark'>Tener actividades extracurriculares / empieza a fallar en algunas materias</option>
                            <option className='font-medium text-dark'>Disponibilidad de tiempo</option>
                            <option className='font-medium text-dark'>Conectividad</option>
