...
const Logic = () => {
    ...
    function logicP() {
        ...
        const view1to6save = JSON.parse(localStorage.getItem('LSview1to6'))
        localStorage.removeItem('LSview1to6')

        // THIS JOIN TWO OBJECTS
        const view1to7 = { ...view1to6save, ...view7 }

        // THIS SEND VIEW1TO7  TO LOCALSTORAGE 
        console.log(view1to7);
        defaultApi
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className='mx-12 sm:mx-40 md:mx-16 lg:mx-28 pb-6'>
                    ...
                    <select
                        ...
                        <option className='font-medium text-dark' value='El orden de llegada es B, C, D, A'>El orden de llegada es B, C, D, A</option>
                        <option className='font-medium text-dark' value='El orden de llegada es B, A, C, D'>El orden de llegada es B, A, C, D</option>
                        <option className='font-medium text-dark' value='El orden de llegada es B, D, C, A'>El orden de llegada es B, D, C, A</option>
                        <option className='font-medium text-dark' value='El orden de llegada es A, B, D, A'>El orden de llegada es A, B, D, A</option>
                    </select>
                ...
                <div className='mx-12 sm:mx-40 md:mx-16 lg:mx-28 pb-6'>
                    <h3 className='pb-1.5 text-dark text-sm font-Nunito font-black'>Un nadador se ve rodeado de un grupo de tiburones, muchos de ellos con problemas de visión. Tres no veían por el ojo derecho, tres no veían por el ojo izquierdo y tres tanto por el derecho como por el izquierdo. Otros tres eran completamente ciegos. ¿Cuántos tiburones había como mínimo? <small className='text-red/80'>*</small></h3>
                    <select
                        value={values.logic2}
                        onChange={handleChange}
                        onBlur={handleBlur}
                                    ...
                                    <div className='flex flex-row'>
                                        <label className='flex justify-center font-Poppins font-extrabold text-center'>
                                            <input
                                                ...
                                                id="logic3"
                                                value="D"
                                                className="accent-red focus:accent-yellow flex items-center" />D.
                                        </label>
                                    </div>
                                    <div className='flex flex-row'>
                                        <label className='flex justify-center font-Poppins font-extrabold text-center'>
                                            <input
                                                ...
                                                id="logic3"
                                                value="E"
                                                className="accent-red focus:accent-yellow flex items-center" />E.
                                        </label>
                                    </div>
                                </div>
                            </article>
